...
class Generar_reporte_municipal extends CI_Controller {
  ...
  function rep($idmunicipio = null,$idnivel = null,$periodo = null,$ciclo = null){
    ...
    $planea_max=$this->DatosMunicipal_model->get_planea_max_periodo_municipal($idnivel);
    $planea_min=$this->DatosMunicipal_model->get_planea_min_periodo_municipal($idnivel);
     // echo "<pre>"; print_r($planea_max); die();
  ...
  function graf($riesgo,$array_datos_escuela,$est_asis_alumnos0,$est_asis_gr0,$est_asis_alumnosh1,$est_asis_alumnosh2,$est_asis_alumnos,$est_asis_gr,$est_asis_alumnos_h1,$est_asis_alumnos_h2,$rez_ed,$rez_na,$analfabeta,$riesgo_alto,$riesgo_muy_alto,$riesgo_alto0,$riesgo_muy_alto0,$riesgo0,$reporte_datos,$planea_mun1,$planea_mun2){
    ...
    $ciclo=mb_strtoupper ($array_datos_escuela['ciclo'], 'UTF-8');
        ...
        <table WIDTH="255">
          <tbody>
            ...
            <tr>
              ...
              <td WIDTH="142" HEIGHT="13"><font face="Montserrat-Bold" color="#555">$ciclo</font></td>
            </tr>
            <tr>
              <td WIDTH="2"></td>
              <td WIDTH="73.88"></td>
...
EOT;
  ...
  <table WIDTH="81mm">
    <tbody>
      ...
      <tr>
        <td width="6.02mm" style="background-color:#D1232A;">&nbsp;</td>
        <td width="21.8mm" style="text-align:center; background-color:#DCDDDF; font-family:Montserrat-Regular; font-size:7; color:#545452;">Muy alto</td>
...
$pdf->SetFont('montserratb', '', 11);
$pdf->SetTextColor(145, 145, 145);
$pdf->MultiCell(65, 8,"Resultados PLANEA ", 0, 'L', 0, 0, 22, 77, 'M');
$style = array('width' => 1, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(192, 192, 192));
...
Se recomienda compartir esta información con instituciones estatales y municipales que puedan contribuir a reintegrar estudiantes.</font></td>
          </tr>
        </tbody>
      </table>
  ';
